...
//End Spam time interval check
  ...
  if(isset($_POST['add_topic_submit'])) {
    ...
    $group_id = $mingleforum->forum_get_group_id($forum_id);
    $msg = '';
  ...
  if(isset($_POST['add_post_submit'])){
    ...
    $forum_id = $mingleforum->forum_get_forum_from_post($thread);
    $group_id = $mingleforum->forum_get_group_from_post($thread);
    $msg = '';
